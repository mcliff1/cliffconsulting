...
const Home = () => {
    return (
          ...
          <p>
          This site hosted in <a href="https://github.com/mcliff1/cliffconsulting">GitHub</a> and has a cloud formation stack that can be run to create a full AWS stack for any branch, including a CI pipeline to automatically deploy.
